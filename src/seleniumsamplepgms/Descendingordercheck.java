 ...
 */
public class Descendingordercheck {
	...
	public static void verifyprice() throws InterruptedException {
		...
		Collections.sort(beforefilterpricelist); //list is sorted in ascending order
		Collections.reverse(beforefilterpricelist); //list is sorted in descending order
